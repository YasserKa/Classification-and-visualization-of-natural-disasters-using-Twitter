...
\end{center}
\caption{\citeauthor{petersenIdentificationExplorationExtreme2021} application}
\label{fig:peter}
\end{figure}
...
\end{center}
\caption{Web map application with pluvial flood in Berlin by \citeauthor{fengExtractionPluvialFlood2018}}
\label{fig:feng}
\end{figure}
...
\end{center}
\caption{Map with tweet markers in by \citeauthor{barkerDevelopmentNationalscaleRealtime2019}}
...
\end{center}
\caption{Bubble map of tweets by \citeauthor{barkerDevelopmentNationalscaleRealtime2019}}
